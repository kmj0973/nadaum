  ...
  return (
    <div className="w-full min-h-[750px] h-[100vh] flex flex-col items-center scroll-auto">
      <div className="bg-white w-full flex flex-col items-center gap-5 py-5">
        ...
        <div className="bg-[#18B491] rounded-xl shadow-md w-[90%] h-[564px] tablet:h-[670px] flex flex-col items-center justify-center gap-5">
          <div>
            <div className="text-white text-2xl font-semibold text-center mb-2">
              근처 체육시설을
              <br />
              간편하게 찾아보세요
            </div>
            <div className="text-[#EEEEEE] text-[13px] text-center">
          ...
          <div className="w-full flex flex-col justify-center items-center">
            <div className="text-white mb-2">원하는 지역을 찾아보세요</div>
            <button className="bg-white/15 text-white border-1 border-white rounded-2xl w-[120px] h-[36px]">
              검색하기
            </button>
          </div>
        </div>
        <div className="w-[90%] flex justify-between items-center">
          <div className="font-semibold rounded-xl shadow-md w-[48%] h-[140px] tablet:h-[220px] p-2">
            출석체크
          </div>
          <div className="font-semibold rounded-xl shadow-md w-[48%] h-[140px] tablet:h-[220px] p-2">
            운동기록
